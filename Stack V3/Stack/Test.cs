    ...
    class Test :OneStack
    {
        public string TestStack()
        {
            ...
            try
            {
                ...
                //проверка на заполненность  и на функцию добавления
                int testtop = top;
                DoPush(5);
                if (top == testtop + 1)
                {
                ...
                //проверка верхушки и дна

                if (PrintTop() == 5)
                    s += "Функция вывода верхушки работает корректно.\n ";
                else
                {
                    s += "Функция вывода  верхушки работает некорректно.\n ";
                    throw new Exception(s);
                }

                if (PrintBot() == 5)
                    s += "Функция вывода дна работает корректно.\n ";
                else
                {
                    s += "Функция повывода дна работает некорректно.\n ";
                    throw new Exception(s);
                }
